  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8" id="u3-lesson3">
      <LessonHeader 
        ...
        mainIdea="تتكوّن المظاهر الجيولوجيّة ومنها السلاسل الجبليّة والأخاديد البحريّة عند حدود الصّفائح، وتُعَدّ تيارات الحمل في السِّتار المسؤولة الرئيسة عن حركة الصّفائح الأرضيّة."
        outcomes={[
          "أتعرّف بنية الأرض الداخليّة.",
          "أحدّد أنواع حدود الصّفائح.",
          "أوضّح العلاقة بين التراكيب الجيولوجيّة وحركة الصّفائح التكتونيّة.",
          "أربط بين حدوث الزلازل والبراكين وبين حدود الصّفائح الأرضيّة."
        ]}
      />
