  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8" id="u4-lesson3">
      ...
      <ConceptBox title="الأثر البيئي المروع للتعدين" icon={ShieldAlert}>
        <p className="text-lg mb-4 text-black">أثناء عمليات التعدين، تتعرض البيئة إلى صدمة قاتلة بسبب عمليات الحفر. من أبرز هذه الأضرار:</p>
      ...
      <ConceptBox title="إدارة التأثير البيئي (الالتزام الأخلاقي)" icon={RefreshCcw}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-white border rounded shadow-sm p-4">
            ...
            <p className="text-black">هدم المنشآت بعد التعدين، تثبيت التربة لتجنب التعرية، والتخلص الآمن والعميق للأنابيب والنفايات السامة (أو المعالجة البيولوجية بالبكتيريا).</p>
          </div>
          <div className="bg-white border rounded shadow-sm p-4">
            <h5 className="font-bold text-emerald-700 text-lg mb-2">2. الترميم (Restoration)</h5>
            <p className="text-black">إعادة المكان والنظام البيئي إلى ما كان عليه قبل التخريب الجائر من خلال زراعة الأشجار وتحويله لمحميات.</p>
          </div>
          <div className="bg-white border rounded shadow-sm p-4">
            <h5 className="font-bold text-emerald-700 text-lg mb-2">3. إعادة الاستخدام (Re-Use)</h5>
            <p className="text-black">تحويل الفجوة القبيحة إلى منطقة جذب سياحي (مثل حدائق بوتشارت) أو مزارع تربية مواشي لاستدامة نفع المكان.</p>
          </div>
        </div>
      </ConceptBox>
