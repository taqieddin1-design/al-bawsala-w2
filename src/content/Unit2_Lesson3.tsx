  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8" id="u2-lesson3">
      <LessonHeader 
        number={3} 
        title="الطيات (Folds)" 
        mainIdea="تنتج الطيات من تعرّض الطبقات الصّخرية لإجهاد الضغط، فتتقوّس نحو الأعلى، أو نحو الأسفل، وتُصنّف الطيّات اعتمادًا على أسس عدّة، منها: اتجاه التّقوس، وزاوية مَيل المستوى المحوريّ."
        outcomes={[
          "أوضّح المقصود بالطية.",
          "أميّز أنواع الطيّات المختلفة.",
          "أُقارن بين القبة والحوض من حيث موقع الصخور الأقدم والأحدث."
        ]}
      />
