  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8" id="u4-lesson2">
      <LessonHeader 
        ...
        mainIdea="تحتوي صخور القشرة الأرضية على خامات معدنِية عدّة، وتُستخدَم طرائق الاستكشاف الجيولوجي المختلفة في البحث عنها؛ لاستثمارها، والاستفادة منها."
        outcomes={[
          "أتعرّف طرائق الاستكشاف الجيولوجي: الجيوفيزيائية، والجيوكيميائية.",
          "أوضّح أهمية الطرائق الجيوفيزيائية والجيوكيميائية في البحث عن الخامات المعدِنِية."
        ]}
      />
