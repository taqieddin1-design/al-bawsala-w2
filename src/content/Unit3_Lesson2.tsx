  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8" id="u3-lesson2">
      <LessonHeader 
        ...
        mainIdea="تتوسّع قيعان المحيطات بصورة مستمرة عند ظَهْر المحيط، ما يؤدي إلى بناء قشرة محيطيّة جديدة فيها."
        outcomes={[
          "أناقش فرضيّة توسّع قاع المحيط بديلًا عن فرضيّة انجراف القارّات.",
          "أحدّد الأدلّة الداعمة لفرضيّة توسّع قاع المحيط.",
          "أربط توسّع قاع المحيط بنشوء قشرة محيطيّة جديدة عند ظهور المحيطات، واستهلاك قشرة محيطيّة قديمة عند أطرافها.",
          "أناقش سبب ثبات حجم الأرض وكتلتها على الرَّغم من توسّع قيعان المحيطات."
        ]}
      />
