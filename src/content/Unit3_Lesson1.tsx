  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8" id="u3-lesson1">
      <LessonHeader 
        ...
        mainIdea="كانت جميع القارّات الحاليّة تشكّل قارّة واحدة تُسمّى بانغيا، ثم انقسمت وأخذت بالتباعُد حتى وصلت إلى وضعها الحالي."
        outcomes={[
          "أشرح السياق التاريخيّ لفرضيّة انجراف القارّات للعالم ألفرد فغنر مع أدلّتها.",
          "أنقض فرضيّة انجراف القارّات بالأدلّة."
        ]}
      />
