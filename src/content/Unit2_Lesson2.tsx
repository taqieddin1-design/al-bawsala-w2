  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8" id="u2-lesson2">
      <LessonHeader 
        number={2} 
        title="الصدوع (Faults)" 
        mainIdea="تظهر الصّدوع في صخور القشرة الأرضية بأشكال مختلفة؛ اعتمادًا على: مَيل مستوى الصّدع، والحركة النسبيّة بين الكُتلتين الصّخريّتين على جانِبيْ مستوى الصّدع."
        outcomes={[
          "أوضّح المقصود بالصّدع.",
          "أميّز أنواع الصّدوع المختلفة.",
          "أربط بين نوع الصّدع ونوع الإجهاد المتسبّب في نشأته.",
          "أوضّح المقصود بأنظمة الصّدوع."
        ]}
      />
