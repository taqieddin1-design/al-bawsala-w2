  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8" id="u4-lesson1">
      <LessonHeader 
        ...
        mainIdea="تُستخدم الخرائط الجيولوجية لتمثيل الطبقات الصخرية والتراكيب الجيولوجية باستخدام رموز خاصّة بذلك."
        outcomes={[
          "أقرأ خريطة جيولوجية لمنطقة ما باستخدام الرموز ومقياس الرسم.",
          "أرسم مقطعًا جيولوجيًّا من الخريطة الجيولوجية تمثّل طبقات أفقية."
        ]}
      />
